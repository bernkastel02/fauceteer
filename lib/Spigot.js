...
module.exports = {
    getLatest: (body, output, type) => {
        ...
        if (type == "bungee" || type == "bungeecord") {
            host = "ci.md-5.net"
        }
        ...
        req.on('response', function(res) {
            ...
            var bar = new ProgressBar({
                ...
                total: len,
                debounce: 800,
                format: "    [Downloading... [:bar] :percent | Estimated Time: :eta ]"
            });
...
function parseType(body, type) {
    ...
    else if (type == "bukkit" || type == "craftbukkit") {
        return body.bukkit
    }
    else if (type == "vanilla") {
        return body.vanilla
    }
    else if (type == "bungee" || type == "bungeecord") {
        return body.bungee;
    }
    else {
        return -1;
